/**
* Name: GROUPE 2
* Author: BYAOMBE MWINDULWA, JIRINCE BIABA, C
* Description: 
* Tags
* 
*/
model Simulation_Ambulances

global {
// Chemin des fichiers shapefile
	file ville_shapefile <- file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/ville.shp");
	file habitation_shapefile <- file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/maison.shp");
	file hospital_shapefile <- file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/hopitaux_v.shp");
	file road_shapefile <- file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/roads.shp");
	file control_center_shapefile <- file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/centre.shp");
	image_file ambulance_image <- image_file("/home/dieudo/Gama_Workspace/simulation_ambulances/includes/ambulance_1.png");
...
experiment TpSMAgroupe2 type: gui {
	parameter "Number of ambulances" var: nb_ambulances min: 0.001 max: 10000;
	output {
